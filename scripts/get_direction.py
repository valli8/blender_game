...
class get_direction():
    ...
    def get_fps_direction(self, up = mathutils.Vector((0,0,1))):
        ...
        self.rotation_matrix.col[0] = self.rotation_matrix.col[1].cross(up).normalized()
        self.rotation_matrix.col[1] = self.rotation_matrix.col[2].cross(self.rotation_matrix.col[0]).normalized()
        ...
        self.rotation_matrix.rotate(mathutils.Quaternion(self.rotation_matrix.col[2],x_rot))
        self.rotation_matrix.rotate(mathutils.Quaternion(self.rotation_matrix.col[0],self.up_down_val))
    ...
    def get_free_direction(self, up = mathutils.Vector((0,0,1))):
        ...
        self.rotation_matrix.col[0] = self.rotation_matrix.col[1].cross(up).normalized()
        self.rotation_matrix.col[1] = self.rotation_matrix.col[2].cross(self.rotation_matrix.col[0]).normalized()
        self.rotation_matrix.col[2] = self.rotation_matrix.col[0].cross(self.rotation_matrix.col[1]).normalized()
        
        self.rotation_matrix.rotate(mathutils.Quaternion(self.rotation_matrix.col[2],x_rot))
        self.rotation_matrix.rotate(mathutils.Quaternion(self.rotation_matrix.col[0],y_rot))
